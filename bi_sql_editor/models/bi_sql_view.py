...
class BiSQLView(models.Model):
    ...
    @api.model
    def button_refresh_materialized_view(self, view_ids):
        self.browse(view_ids)._refresh_materialized_view()
    ...
    def _prepare_cron(self):
        ...
        return {
            ...
            'model_id': self.env.ref('bi_sql_editor.model_bi_sql_view').id,
